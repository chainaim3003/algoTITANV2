/**
 * Atomic Marketplace Escrow V4 - Updated Version
 * 
 * CHANGES FROM PREVIOUS VERSION:
 * 1. Removed hardcoded demo addresses (importerBuyer1, financierLarge1)
 * 2. Removed amountDivisor (division handled in UI)
 * 3. Added flexible settlement currency (ALGO or USDCA)
